(function( $ ) {
	var calenderTpl = '<div id="calTitle"><button class="month-mover prev"><i class="fas fa-arrow-left"></i></button><div id="monthYear"></div><button class="month-mover next"><i class="fas fa-arrow-right"></i></button></div><div><div id="calThead"><div>MO</div><div>TU</div><div>WD</div><div>TH</div><div>FR</div><div>SA</div><div>SU</div></div><div id="calTbody"></div></div><div id="calTFooter"><h3 id="eventTitle">No events today.</h3><a href="javascript:void(0);" id="calLink">ALL EVENTS</a></div>';
	var short_months = ["Jan", "February", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
	var today = new Date();
